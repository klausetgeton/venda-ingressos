...
<div class="container">
	...
	{!! Form::open(array('name' => 'discountForm', 'method'=>'POST', 'id' => 'discountForm', 'url' => '')) !!}	
		...
		<div class="form-group">
			...
			{!! Form::number('porcentagem', Input::old('porcentagem'), ['class'=>'form-control', 'required' => 'true']) !!}
		</div>

		<div class="form-group">
			{!! Form::label('quantidade', 'Quantidade:') !!}
			{!! Form::number('quantidade', Input::old('quantidade'), ['class'=>'form-control', 'required' => 'true']) !!}
		</div>

		<div class="form-group">
			{!! Form::label('hash', 'Hash:') !!}
			{!! Form::text('hash', Input::old('hash'), ['class'=>'form-control', 'required' => 'true']) !!}
		</div>
	...
	<a class="btn btn-primary" href="{{ route('discounts.index') }}"><< Etapa Anterior</a>
	<a class="btn btn-primary" href="{{ route('events.finish', ['id' => session()->get('event_id')]) }}">Finalizar</a>
	</br>
	</br>
